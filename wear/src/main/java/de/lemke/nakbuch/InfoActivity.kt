...
class InfoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            findViewById<TextView>(R.id.tvVersion).text = getString(de.dlyt.yanndroid.oneui.R.string.sesl_version) + " " + packageManager.getPackageInfo(packageName, 0).versionName
    ...
    private fun openAppInStoreOnPhone() {
        if (PhoneTypeHelper.getPhoneDeviceType(this) != PhoneTypeHelper.DEVICE_TYPE_ANDROID) {
            return
        }
